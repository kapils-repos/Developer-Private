...
def writeToJSONFile(data):
    filePathNameWExt = '/home/travis/build/kapils-repos/Developer-Private/Pull-Config/manifest.json'
    with open(filePathNameWExt, 'w') as fp:
        json.dump(data, fp)

#Function to write the attributes to a new JSON file
def writeToNewJSONFile(data):
    filePathNameWExt = '/home/travis/build/kapils-repos/Developer-Private/Pull-Config/manifest_new.json'
    with open(filePathNameWExt, 'w') as fp:
        json.dump(data, fp)
...
def getUsername(hash_code, git_password):
    ...
    response = requests.get(
        'https://api.github.com/repos/kapils-repos/Developer-Private/commits/'+hash_code,auth=('kapils-repos', git_password))
...
def gitApiCall(hash_code, git_password):
    response = requests.get(
        'https://api.github.com/repos/kapils-repos/Developer-Private/commits/' + hash_code,
...
def main():
    ...
    fileLocation="/home/travis/build/kapils-repos/Developer-Private/"+file
    artifactUrl="https://github.com/kapils-repos/Developer-Private/blob/master/"+file
    print(files)
    ...
    manifestRead = open("/home/travis/build/kapils-repos/Developer-Private/Pull-Config/manifest.json", 'r')
    ...
    if lineVal[1].split(':')[0] != "id":
        ...
        newFile = open("/home/travis/build/kapils-repos/Developer-Private/Developer-Private/"+category+"/newFile.md","w+")
        newFile.write("---")
        newFile.write("\nid: \""+artifactKey+"\"")
        ...
        os.rename("/home/travis/build/kapils-repos/Developer-Private/Developer-Private/"+category+"/newFile.md", "/home/travis/build/kapils-repos/Developer-Private/Developer-Private/"+file)
        ...
        if flag=="Y":
            for i in range(0, l):
                if data['artifacts'][i]['artifactKey']==lineVal[1].split(':')[1].strip().replace("\"", ""):
                    ...
                    folder = "/home/travis/build/kapils-repos/Developer-Private/"
            ...
            os.remove('/home/travis/build/kapils-repos/Developer-Private/Pull-Config/manifest.json')
            os.rename('/home/travis/build/kapils-repos/Developer-Private/Pull-Config/manifest_new.json',
                      '/home/travis/build/kapils-repos/Developer-Private/Pull-Config/manifest.json')
            ...
            os.remove(fileLocation)
            os.rename("/home/travis/build/kapils-repos/Developer-Private/Developer-Private/" + category + "/newFile.md",
                      "/home/travis/build/kapils-repos/Developer-Private/Developer-Private/" + file)
